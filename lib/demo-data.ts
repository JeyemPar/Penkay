export const producerMetrics = [
  { label: 'Plantas activas', value: '1.306', note: 'de 1.420 establecidas', change: '+36 nuevas' },
  { label: 'Supervivencia', value: '92%', note: 'último monitoreo', change: '+2,4%' },
  { label: 'Área utilizada', value: '2,4 ha', note: 'en 3 parcelas', change: '0,7 ha conservadas' },
  { label: 'Próxima actividad', value: '08 sep', note: 'vuelo con drone', change: 'Parcela A' },
];

export const timeline = [
  { date: '03 sep 2026', title: 'Monitoreo de parcela A', detail: 'Supervivencia actualizada al 92%', type: 'Medición de campo' },
  { date: '15 ago 2026', title: 'Registro fotográfico', detail: '12 fotografías georreferenciadas', type: 'Observado' },
  { date: '28 jul 2026', title: 'Análisis básico del suelo', detail: 'pH 6,4 · erosión baja', type: 'Laboratorio' },
  { date: '17 jun 2026', title: 'Vuelo PencoMRV', detail: 'Ortomosaico y modelo de pendiente', type: 'Drone' },
];
